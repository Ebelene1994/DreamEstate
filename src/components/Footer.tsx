...
import { Home, Phone, Mail, MapPin, Facebook, Twitter, Instagram, Linkedin, CheckCircle, AlertCircle, Loader2 } from 'lucide-react';
...
const Footer = () => {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('error');
      setStatusMessage('Unable to subscribe. Please check your connection.');
    }
  };
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <p className="text-gray-400 text-sm">
              © 2024 DreamEstate. All rights reserved. &nbsp;|&nbsp; Designed with ❤ by{' '}
              <a
                href="https://myportfolio-nine-tau-89.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
