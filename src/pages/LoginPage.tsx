      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="mt-6 p-4 bg-purple-50 rounded-xl">
            <p className="text-sm text-purple-700 font-medium mb-1">💡 New here?</p>
            <p className="text-sm text-purple-600">Sign up to track listings and manage your profile from your personal dashboard.</p>
          </div>
        </div>
      </div>
    </div>
